...
# DEPLOYING UOD WALLPAPERS VIA JAMF POLICY TRIGGER
	echo "Status: Installing - UoD Wallpapers..." >> $depnLog
	sudo /usr/local/jamf/bin/jamf policy -trigger pkg_uodwallpapers
    sleep 1
